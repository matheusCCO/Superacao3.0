...
require_once('fn_quantidade_de_Objetivo.php');
function addObjetivos($connect, $id_colaborador)
{
    if (isset($_GET['adicionar'])) {
        ...
        if ($limiteDeObjetivos >= 5) {
            ...
            $peso = $_GET['peso'];
            if (!empty($nomeOjetivo) && !empty($decricaoOjetivo) && !empty($peso)) {
                ...
                echo "<h3 class='retornoAlerta'>Treencha todos os campos.</h3>";
            }
        }
    }
}
